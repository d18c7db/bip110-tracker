...
## Live Dashboard
View the real-time interactive adoption graph 
**[here](https://d18c7db.github.io/bip110-tracker/)**.

---

## About BIP110: Protecting Bitcoin's Purpose
BIP110 proposes to temporarily limit the size of data fields at the consensus level.  
...
1.  **Data Collection**: A GitHub Action triggers a Python script (`bip110-tracker.py`) once per hour.
